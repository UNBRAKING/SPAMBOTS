...
BOT_TOKEN = getenv("7562440740:AAFJxxxjXHWm7BDmnsbCfTsZfAD3s9UgiIY", default=None)
BOT_TOKEN2 = getenv("7512613727:AAE4bmjZuGDEOZvUP_rIOYxz1yLEle6eEUo", default=None)
...
SUDO_USERS = list(map(lambda x: int(x), getenv("SUDO_USERS", default="5606990991").split()))
for x in OXYGEN:
    SUDO_USERS.append(x)
OWNER_ID = int(getenv("5606990991", default="OWNER_ID"))
